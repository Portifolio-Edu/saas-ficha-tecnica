...
insert into ids select salvar_pessoa_escala(null, ' Rui ', 'outro', 'Segurança', null, '{}', '2026-02-01', null, '12x36', '2026-10-01', '{}', null, '19:00', '07:00');
...
select salvar_pessoa_escala((select id from ids), 'Rui', 'cozinha', 'Cozinheiro', 'pleno', '{grelha}', '2026-02-01', null, '5x2', '2026-10-05', '{1,3}', null, null, null);
...
select salvar_pessoa_escala((select id from ids), 'Rui', 'outro', 'Segurança', null, '{}', '2026-02-01', null, '24x48', '2026-10-01', '{}', null, null, null);
...
do $$ begin
  begin perform salvar_pessoa_escala((select id from ids), 'Rui', 'bar', 'Barman', null, '{}', '2026-02-01', null, '12x36', '2026-10-01', '{}', null, null, null);
...
do $$ begin
  begin perform salvar_pessoa_escala(null, 'X', 'cozinha', 'Cozinheiro', null, '{}', '2026-02-01', null, '5x2', '2026-10-01', '{}', null, null, null);
