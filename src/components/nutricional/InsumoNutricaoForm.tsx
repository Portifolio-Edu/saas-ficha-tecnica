  ...
  return (
    <div className="px-4 py-3 rounded-lg" style={{ background: "var(--bg)", border: `1px solid ${"var(--border)"}` }}>
      ...
      <div className="flex gap-2">
        <button onClick={salvar} disabled={salvando} className="text-[12px] font-medium px-3 py-1.5 rounded-lg" style={{ background: "var(--accent)", color: "var(--accent-contrast, #fff)", opacity: salvando ? 0.6 : 1 }}>
