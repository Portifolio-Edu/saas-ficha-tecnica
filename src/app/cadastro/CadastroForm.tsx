...
export function CadastroForm() {
  ...
  return (
    <Card className="p-6 w-full max-w-md">
      ...
      <p className="text-[12.5px] mb-5" style={{ color: C.sub }}>Leva menos de um minuto. Depois é só cadastrar insumo e receita pra ver o CMV de verdade.</p>

      {estado.sucesso ? (
        <div className="text-[12.5px] rounded-md px-3 py-3" style={{ background: C.accentSoft, color: C.accent }}>
          {estado.sucesso}{" "}
        ...
        <form action={formAction} className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <div className="text-[11px] mb-1" style={{ color: C.faint }}>Seu nome</div>
              <input id="nome" name="nome" required className="text-[12.5px] px-2.5 py-1.5 rounded-md w-full" style={inputStyle} />
            </div>
            <div>
              <div className="text-[11px] mb-1" style={{ color: C.faint }}>Nome do restaurante</div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <div className="text-[11px] mb-1" style={{ color: C.faint }}>Telefone</div>
