...
export const insumos: Insumo[] = [
  { id: "i-frango", nome: "Peito de Frango", categoria: "proteina" as Categoria, unidadeMedida: "kg", tamanhoEmbalagem: 5, precoEmbalagem: 89.5, precoUnitario: 17.9, fatorCorrecao: 1.12, pesoPorUnidade: null, estoque: { saldoAtual: 18, estoqueMinimo: 10 } },
  { id: "i-patinho", nome: "Carne Bovina Patinho", categoria: "proteina", unidadeMedida: "kg", tamanhoEmbalagem: 10, precoEmbalagem: 349, precoUnitario: 34.9, fatorCorrecao: 1.18, pesoPorUnidade: null, estoque: { saldoAtual: 22, estoqueMinimo: 15 } },
  { id: "i-calabresa", nome: "Linguiça Calabresa", categoria: "proteina", unidadeMedida: "kg", tamanhoEmbalagem: 5, precoEmbalagem: 74.5, precoUnitario: 14.9, fatorCorrecao: 1.05, pesoPorUnidade: null, estoque: { saldoAtual: 9, estoqueMinimo: 12 } },
  { id: "i-camarao", nome: "Camarão Médio Limpo", categoria: "proteina", unidadeMedida: "kg", tamanhoEmbalagem: 2, precoEmbalagem: 159.8, precoUnitario: 79.9, fatorCorrecao: 1.08, pesoPorUnidade: null, estoque: { saldoAtual: 4, estoqueMinimo: 5 } },
  { id: "i-mussarela", nome: "Mussarela", categoria: "laticinio", unidadeMedida: "kg", tamanhoEmbalagem: 5, precoEmbalagem: 149.5, precoUnitario: 29.9, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 30, estoqueMinimo: 15 } },
  { id: "i-parmesao", nome: "Parmesão Ralado", categoria: "laticinio", unidadeMedida: "kg", tamanhoEmbalagem: 1, precoEmbalagem: 68.9, precoUnitario: 68.9, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 6, estoqueMinimo: 4 } },
  { id: "i-manteiga", nome: "Manteiga sem Sal", categoria: "laticinio", unidadeMedida: "kg", tamanhoEmbalagem: 5, precoEmbalagem: 94.5, precoUnitario: 18.9, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 8, estoqueMinimo: 5 } },
  { id: "i-leite", nome: "Leite Integral", categoria: "laticinio", unidadeMedida: "l", tamanhoEmbalagem: 12, precoEmbalagem: 71.88, precoUnitario: 5.99, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 24, estoqueMinimo: 12 } },
  { id: "i-tomate", nome: "Tomate Italiano", categoria: "hortalica", unidadeMedida: "kg", tamanhoEmbalagem: 20, precoEmbalagem: 139.8, precoUnitario: 6.99, fatorCorrecao: 1.15, pesoPorUnidade: null, estoque: { saldoAtual: 40, estoqueMinimo: 20 } },
  { id: "i-cebola", nome: "Cebola Branca", categoria: "hortalica", unidadeMedida: "kg", tamanhoEmbalagem: 20, precoEmbalagem: 79.8, precoUnitario: 3.99, fatorCorrecao: 1.1, pesoPorUnidade: null, estoque: { saldoAtual: 25, estoqueMinimo: 15 } },
  { id: "i-alho", nome: "Alho Descascado", categoria: "tempero", unidadeMedida: "kg", tamanhoEmbalagem: 1, precoEmbalagem: 32.9, precoUnitario: 32.9, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 3, estoqueMinimo: 2 } },
  { id: "i-manjericao", nome: "Manjericão Fresco", categoria: "tempero", unidadeMedida: "kg", tamanhoEmbalagem: 0.5, precoEmbalagem: 24.9, precoUnitario: 49.8, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 1.2, estoqueMinimo: 1 } },
  { id: "i-sal", nome: "Sal Refinado", categoria: "tempero", unidadeMedida: "kg", tamanhoEmbalagem: 25, precoEmbalagem: 37.5, precoUnitario: 1.5, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 50, estoqueMinimo: 10 } },
  { id: "i-azeite", nome: "Azeite de Oliva Extra Virgem", categoria: "outro", unidadeMedida: "l", tamanhoEmbalagem: 5, precoEmbalagem: 189.5, precoUnitario: 37.9, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 14, estoqueMinimo: 6 } },
  { id: "i-farinha", nome: "Farinha de Trigo Tipo 1", categoria: "outro", unidadeMedida: "kg", tamanhoEmbalagem: 25, precoEmbalagem: 112.5, precoUnitario: 4.5, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 60, estoqueMinimo: 25 } },
  { id: "i-fermento", nome: "Fermento Biológico Seco", categoria: "outro", unidadeMedida: "kg", tamanhoEmbalagem: 0.5, precoEmbalagem: 22.9, precoUnitario: 45.8, fatorCorrecao: 1.0, pesoPorUnidade: null, estoque: { saldoAtual: 2.5, estoqueMinimo: 1 } },
  { id: "i-limao", nome: "Limão Siciliano", categoria: "fruta", unidadeMedida: "kg", tamanhoEmbalagem: 10, precoEmbalagem: 69.9, precoUnitario: 6.99, fatorCorrecao: 1.2, pesoPorUnidade: null, estoque: { saldoAtual: 8, estoqueMinimo: 4 } },
  { id: "i-caixa-pizza", nome: "Caixa de Pizza 35cm", categoria: "embalagem", unidadeMedida: "un", tamanhoEmbalagem: 100, precoEmbalagem: 145, precoUnitario: 1.45, fatorCorrecao: 1.0, pesoPorUnidade: 0.08, estoque: { saldoAtual: 320, estoqueMinimo: 150 } },
  { id: "i-marmita", nome: "Embalagem Marmita 500ml", categoria: "embalagem", unidadeMedida: "un", tamanhoEmbalagem: 100, precoEmbalagem: 89, precoUnitario: 0.89, fatorCorrecao: 1.0, pesoPorUnidade: 0.03, estoque: { saldoAtual: 180, estoqueMinimo: 100 } },
];
...
export const registrosTemperatura: RegistroTemperatura[] = [
  { id: "temp-1", localArmazenamentoId: "local-camara-carnes", nomeLocal: "Câmara Fria — Carnes", temperaturaC: -14, responsavel: "Marcos Silva", registradoEm: "2026-09-15T08:00:00.000Z" },
  { id: "temp-2", localArmazenamentoId: "local-geladeira-laticinios", nomeLocal: "Geladeira — Laticínios", temperaturaC: 4, responsavel: "Ana Souza", registradoEm: "2026-09-15T08:05:00.000Z" },
  { id: "temp-3", localArmazenamentoId: "local-geladeira-hortifruti", nomeLocal: "Geladeira — Hortifruti", temperaturaC: 5.5, responsavel: "Ana Souza", registradoEm: "2026-09-15T08:10:00.000Z" },
  { id: "temp-4", localArmazenamentoId: "local-camara-carnes", nomeLocal: "Câmara Fria — Carnes", temperaturaC: -13, responsavel: "Pedro Alves", registradoEm: "2026-09-16T08:00:00.000Z" },
  // Fora da faixa — caso de alerta em Segurança/Relatórios.
  { id: "temp-5", localArmazenamentoId: "local-geladeira-laticinios", nomeLocal: "Geladeira — Laticínios", temperaturaC: 8.5, responsavel: "Pedro Alves", registradoEm: "2026-09-16T08:05:00.000Z" },
  { id: "temp-6", localArmazenamentoId: "local-geladeira-hortifruti", nomeLocal: "Geladeira — Hortifruti", temperaturaC: 6, responsavel: "Juliana Costa", registradoEm: "2026-09-16T08:10:00.000Z" },
];
